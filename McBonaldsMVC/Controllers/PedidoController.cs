    ...
    public class PedidoController : AbstractController {
        ...
        public IActionResult Registrar (IFormCollection form) {
            ...
            if (pedidoRepository.Inserir (pedido)) {
                return View ("Sucesso", new RespostaViewModel () {
                    NomeView = "Pedido",
                        Mensagem = $"{cliente.Nome} seu pedido foi concluido!"
                });

            } else {
                return View ("Erro", new RespostaViewModel () {
                    NomeView = "Pedido",
                        Mensagem = $"{cliente.Nome} seu pedido nao foi concluido!"
                });
            }
        ...
        public IActionResult Reprovar (ulong id) {
            ...
            if (pedidoRepository.Atualizar (pedido)) {
                ...
                return View ("Erro", new RespostaViewModel ("Nao foi possivel reprovar este pedido") {
                    NomeView = "Dashboard",
                        UsuarioEmail = ObterUsuarioSession (),
                        UsuarioNome = ObterUsuarioNomeSession ()
                });
